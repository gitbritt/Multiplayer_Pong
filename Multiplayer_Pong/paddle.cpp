...
sf::RectangleShape GUI::paddle1()
{
	...
	paddle1.setPosition(12, 100);							//Sets the x and y coordinates of locaiton of the paddle on the screen for paddle 1
	return paddle1;
}
...
sf::RectangleShape GUI::paddle2()
{
	...
	paddle2.setPosition(980, 100);							//Sets the x and y coordinates of locaiton of the paddle on the screen for paddle 1
	return paddle2;	
}
...
sf::RectangleShape GUI::paddle_moving_local(sf::RectangleShape local_paddle, sf::Event event)
{
	...
	if (y <= 100)
		...
		y = 500;
	local_paddle.setPosition(local_paddle.getPosition().x, y - 100.0);
	return local_paddle;
}
